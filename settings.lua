data:extend{
    ...
    {
        type = "string-setting",
        name = "BlueprintExtensions_version-tag",
        setting_type = "runtime-per-user",
        order = 102,
        default_value = 'v'
    },
    ...
    {
        type = "string-setting",
        name = "BlueprintExtensions_landfill-mode",
        setting_type = "runtime-per-user",
        order = 401,
    ...
    {
        type = "bool-setting",
        name = "BlueprintExtensions_show-mirror",
        setting_type = "runtime-per-user",
        order = 500,
        default_value = true,
    },
    {
        type = "bool-setting",
        name = "BlueprintExtensions_show-rotate",
        setting_type = "runtime-per-user",
        order = 501,
        default_value = true,
    },
    {
        type = "bool-setting",
        name = "BlueprintExtensions_show-clone",
        setting_type = "runtime-per-user",
        order = 502,
        default_value = true,
    },
    {
        type = "bool-setting",
        name = "BlueprintExtensions_show-wireswap",
        setting_type = "runtime-per-user",
        order = 503,
        default_value = true,
    },
    {
        type = "bool-setting",
        name = "BlueprintExtensions_show-landfill",
        setting_type = "runtime-per-user",
        order = 504,
        default_value = true,
    },
